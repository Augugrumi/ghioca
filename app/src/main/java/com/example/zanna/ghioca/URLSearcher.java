...
class URLSearcher {
    ...
    public JSONObject search() throws IOException, JSONException {
    ...
    private ArrayList<String> retrieveSimilarImageFromHTML(Elements body) throws JSONException {
